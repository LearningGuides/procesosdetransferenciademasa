...
# 14. Método recomendado para resolver problemas

Cuando encuentres un problema de coeficientes de transferencia de masa, identifica primero **qué te están pidiendo y cuál es la fuerza impulsora**.

Después sigue esta secuencia:

$$
\underline{\text{1. Identificar las dos condiciones}}
$$
...
$$
\underline{\text{2. Calcular la fuerza impulsora}}
$$

$$
\Delta C,\quad\Delta P,\quad\Delta y
$$
...
$$
\underline{\text{3. Seleccionar el coeficiente correcto}}
$$

$$
k_c,\quad k_G,\quad k_L,\quad k_y
$$
...
$$
\underline{\text{4. Calcular el flujo}}
$$

$$
N_A=k(\text{fuerza impulsora})
$$
...
$$
\underline{\text{5. Multiplicar por el área si se requiere transferencia total}}
$$
...
$$
\underline{\text{6. Multiplicar por tiempo si se pide cantidad transferida}}
$$
...
Intenta resolverlos antes de consultar la Lección 2.
...
### Lo que debes dominar antes de continuar

Las cuatro ecuaciones esenciales de esta primera lección son:
